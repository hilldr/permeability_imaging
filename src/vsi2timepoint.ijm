...
function vsi2timepoint(dir, filename, timepoint) {
    ...
    run("Bio-Formats Importer",
     	"open="+dir+filename+" color_mode=Grayscale rois_import=[ROI manager] specify_range view=Hyperstack stack_order=XYCZT series_1 c_begin_1=1 c_end_1=3 c_step_1=1 t_begin_1=timepoint t_end_1=timepoint t_step_1=1");
